...
class Items(object):
    ...
    def use_teleporters(self):
        if "Clara" in doctor.inv:
            ...
            teleport_species = "yes"
        else:
            print("Nobody to teleport.")
    def use_control_panel(self):
        if "Clara" in doctor.inv and teleport_species == "yes":
...
while True:
    ...
    if command == "use tardis key":
        if doctor.location == engine:
            if "Clara" in doctor.inv and teleport_species == "yes" and return_ship == "yes":
                ...
                time.sleep(2)
                break
            elif "Clara" in doctor.inv and teleport_species == "yes" and return_ship == "no":
                print("We need to send a message.")
                print("Let's head to the Main Control room")
            elif "Clara" in doctor.inv and teleport_species == "no" and return_ship == "yes":
                print("You need to save the other species")
                print("Head to the teleportation room")
            elif "Clara" in doctor.inv and teleport_species == "no" and return_ship == "no":
                print("You need to save the other species")
                print("Head to the teleportation room")
