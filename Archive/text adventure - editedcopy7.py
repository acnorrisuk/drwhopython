...
room5 = Room("Corridor #22","You are at a crossroad between two corridors\
...
room7 = Room("Corridor #30", "You are in a metallic grey corridor.\
             \nA sign on the wall says #30","none")
room8 = Room("Corridor #32","You are in a metallic grey corridor.\
             \nA sign on the wall says #32",["Door"])
...
room7.coordinates = [0,room8,0,roomC]
...
class Items(object):
    ...
    def door_block(self):
        if doctor.location == room8:
            print("You see a locked door to the west")
            print("ENTER PASSCODE: ")
            doctor.location.coordinates = [0, room9, 0, 0]
        elif doctor.location == room7:
            print("You see a locked door to the east")
            print("ENTER PASSCODE: ")
            doctor.location.coordinates = [0, 0, 0, roomC]
        else:
            pass
...
while True:
    ...
    passcode = "1234" or "1 2 3 4"
    if command == passcode:
        if doctor.location == room8:
            print("ACCESS GRANTED")
            doctor.location.coordinates = [0, room9, 0, room7]
        elif doctor.location == room7:
            print("ACCESS GRANTED")
            doctor.location.coordinates = [0, room8, 0, roomC]
        else:
            print("It had no effect")
