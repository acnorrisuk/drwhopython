...
class Character(object):
    ...
    def room_descrip(self):
        if self.location.name == "Cargo":
            input("You are in a large room")
            input("There are crates piled from floor to ceiling.")
        elif self.location.name == "Corridor #1":
            input("You are in a metallic grey corridor.")
        elif self.location.name == "Engine room":
            input("You are in an engine room")
        elif self.location.name == "Capt. Office":
            input("You are in a small room with a desk.")
            input("There is a bookshelf in the corner")
        elif self.location.name == "Corridor #2":
            input("Two corridors join together.")
            input("From here you can travel any direction but South")
        elif self.location.name == "Security":
            input("You are in a security room.")
        elif self.location.name == "Corridor #3":
            input("You are in a metallic grey corridor.")
        elif self.location.name == "Corridor #4":
            input("You are in a metallic grey corridor.")
        elif self.location.name == "Control room":
            input("You are in a room marked 'Controls'")
        elif self.location.name == "Passenger room":
            input("A sign above reads: 'PASSENGERS'")
            input("You see rows and rows of stasis pods")
            input("Inside each one is a different species")
            input("Sycorax, Krillitanes, Ood, Weevils, Tritovores...")
            input("All unconscious and being monitored")
        elif self.location.name == "Capt.Quarters":
            input("You are in the Captain's Quarters.")
